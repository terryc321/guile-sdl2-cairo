...
# compile step only
${CC} ${CFLAGS_SDL} ${CFLAGS_GUILE} ${CFLAGS_CAIRO} -Wall -fPIC -c pixelformat.c

# dynamic link step
${CC} -shared -Wl,-soname,libpixelformat.so -lSDL2 -lcairo -lguile-3.0 -o libpixelformat.so pixelformat.o
