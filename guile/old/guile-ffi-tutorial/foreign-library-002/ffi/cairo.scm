...
(define-public cairo_matrix_t*-desc
  (bs:pointer cairo_matrix_t-desc))
...
(define-public cairo_destroy_func_t-desc
  (bs:pointer
    (delay (fh:function 'void (list (bs:pointer 'void)))))
  )
...
(define-public cairo_user_data_key_t*-desc
  (bs:pointer cairo_user_data_key_t-desc))
...
(define-public (unwrap-cairo_status_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_status_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_STATUS_LAST_STATUS,
;; };
(define enum-_cairo_status-enum-nvl
  '((CAIRO_STATUS_SUCCESS . 0)
    (CAIRO_STATUS_NO_MEMORY . 1)
    (CAIRO_STATUS_INVALID_RESTORE . 2)
    (CAIRO_STATUS_INVALID_POP_GROUP . 3)
...
(define enum-_cairo_status-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_status-enum-nvl))
(define-public (unwrap-enum-_cairo_status n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_status-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_status v)
  (assq-ref enum-_cairo_status-enum-vnl v))
...
(define-public (unwrap-cairo_content_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_content_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_CONTENT_COLOR_ALPHA = 0x3000,
;; };
(define enum-_cairo_content-enum-nvl
  '((CAIRO_CONTENT_COLOR . 4096)
    (CAIRO_CONTENT_ALPHA . 8192)
    (CAIRO_CONTENT_COLOR_ALPHA . 12288))
  )
(define enum-_cairo_content-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_content-enum-nvl))
(define-public (unwrap-enum-_cairo_content n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_content-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_content v)
  (assq-ref enum-_cairo_content-enum-vnl v))
...
(define-public (unwrap-cairo_format_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_format_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_FORMAT_RGBA128F = 7,
;; };
(define enum-_cairo_format-enum-nvl
  '((CAIRO_FORMAT_INVALID . -1)
    (CAIRO_FORMAT_ARGB32 . 0)
    (CAIRO_FORMAT_RGB24 . 1)
    (CAIRO_FORMAT_A8 . 2)
...
(define enum-_cairo_format-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_format-enum-nvl))
(define-public (unwrap-enum-_cairo_format n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_format-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_format v)
  (assq-ref enum-_cairo_format-enum-vnl v))
...
;;   CAIRO_DITHER_BEST,
;; } cairo_dither_t;
(define cairo_dither_t-enum-nvl
  '((CAIRO_DITHER_NONE . 0)
...
(define cairo_dither_t-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       cairo_dither_t-enum-nvl))
(define-public (unwrap-cairo_dither_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_dither_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-cairo_dither_t v)
  (assq-ref cairo_dither_t-enum-vnl v))
(define-public unwrap-enum-_cairo_dither unwrap-cairo_dither_t)
(define-public wrap-enum-_cairo_dither wrap-cairo_dither_t)
...
;;   CAIRO_DITHER_BEST,
;; };
(define enum-_cairo_dither-enum-nvl
  '((CAIRO_DITHER_NONE . 0)
    (CAIRO_DITHER_DEFAULT . 1)
    (CAIRO_DITHER_FAST . 2)
    (CAIRO_DITHER_GOOD . 3)
...
(define enum-_cairo_dither-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_dither-enum-nvl))
(define-public (unwrap-enum-_cairo_dither n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_dither-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_dither v)
  (assq-ref enum-_cairo_dither-enum-vnl v))

;; extern void cairo_pattern_set_dither(cairo_pattern_t *pattern, 
;;     cairo_dither_t dither);
(define cairo_pattern_set_dither
  (let ((~cairo_pattern_set_dither
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (pattern dither)
      (let ((~pattern
            ...
            (~dither (unwrap-cairo_dither_t dither)))
        ((force ~cairo_pattern_set_dither)
         ~pattern
         ~dither)))))
(export cairo_pattern_set_dither)

;; extern cairo_dither_t cairo_pattern_get_dither(cairo_pattern_t *pattern);
(define cairo_pattern_get_dither
  (let ((~cairo_pattern_get_dither
          (delay (fh-link-proc
                   ffi:int
    ...
    (lambda (pattern)
      (let ((~pattern
              ((fht-unwrap cairo_pattern_t*) pattern)))
        (wrap-cairo_dither_t
          ((force ~cairo_pattern_get_dither) ~pattern))))))
(export cairo_pattern_get_dither)
...
(define-public cairo_rectangle_int_t*-desc
  (bs:pointer cairo_rectangle_int_t-desc))
...
(define-public (unwrap-cairo_operator_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_operator_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_OPERATOR_HSL_LUMINOSITY,
;; };
(define enum-_cairo_operator-enum-nvl
  '((CAIRO_OPERATOR_CLEAR . 0)
    (CAIRO_OPERATOR_SOURCE . 1)
    (CAIRO_OPERATOR_OVER . 2)
    (CAIRO_OPERATOR_IN . 3)
...
(define enum-_cairo_operator-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_operator-enum-nvl))
(define-public (unwrap-enum-_cairo_operator n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_operator-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_operator v)
  (assq-ref enum-_cairo_operator-enum-vnl v))
...
(define-public (unwrap-cairo_antialias_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_antialias_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_ANTIALIAS_BEST,
;; };
(define enum-_cairo_antialias-enum-nvl
  '((CAIRO_ANTIALIAS_DEFAULT . 0)
    (CAIRO_ANTIALIAS_NONE . 1)
    (CAIRO_ANTIALIAS_GRAY . 2)
    (CAIRO_ANTIALIAS_SUBPIXEL . 3)
...
(define enum-_cairo_antialias-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_antialias-enum-nvl))
(define-public (unwrap-enum-_cairo_antialias n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_antialias-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_antialias v)
  (assq-ref enum-_cairo_antialias-enum-vnl v))
...
(define-public (unwrap-cairo_fill_rule_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_fill_rule_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_FILL_RULE_EVEN_ODD,
;; };
(define enum-_cairo_fill_rule-enum-nvl
  '((CAIRO_FILL_RULE_WINDING . 0)
    (CAIRO_FILL_RULE_EVEN_ODD . 1))
  )
(define enum-_cairo_fill_rule-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_fill_rule-enum-nvl))
(define-public (unwrap-enum-_cairo_fill_rule n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_fill_rule-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_fill_rule v)
  (assq-ref enum-_cairo_fill_rule-enum-vnl v))
...
(define cairo_set_hairline
  (let ((~cairo_set_hairline
          (delay (fh-link-proc
                   ffi:void
                   "cairo_set_hairline"
                   (list ffi-void* ffi:int)
    ...
    (lambda (cr set_hairline)
      (let ((~cr ((fht-unwrap cairo_t*) cr))
            (~set_hairline (unwrap~fixed set_hairline)))
        ((force ~cairo_set_hairline) ~cr ~set_hairline)))))
(export cairo_set_hairline)
...
(define-public (unwrap-cairo_line_cap_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_line_cap_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_LINE_CAP_SQUARE,
;; };
(define enum-_cairo_line_cap-enum-nvl
  '((CAIRO_LINE_CAP_BUTT . 0)
    (CAIRO_LINE_CAP_ROUND . 1)
    (CAIRO_LINE_CAP_SQUARE . 2))
  )
(define enum-_cairo_line_cap-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_line_cap-enum-nvl))
(define-public (unwrap-enum-_cairo_line_cap n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_line_cap-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_line_cap v)
  (assq-ref enum-_cairo_line_cap-enum-vnl v))
...
(define-public (unwrap-cairo_line_join_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_line_join_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_LINE_JOIN_BEVEL,
;; };
(define enum-_cairo_line_join-enum-nvl
  '((CAIRO_LINE_JOIN_MITER . 0)
    (CAIRO_LINE_JOIN_ROUND . 1)
    (CAIRO_LINE_JOIN_BEVEL . 2))
  )
(define enum-_cairo_line_join-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_line_join-enum-nvl))
(define-public (unwrap-enum-_cairo_line_join n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_line_join-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_line_join v)
  (assq-ref enum-_cairo_line_join-enum-vnl v))
...
(define-public cairo_rectangle_list_t*-desc
  (bs:pointer cairo_rectangle_list_t-desc))
...
(define-public cairo_text_cluster_t*-desc
  (bs:pointer cairo_text_cluster_t-desc))
...
(define-public (unwrap-cairo_text_cluster_flags_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_text_cluster_flags_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_TEXT_CLUSTER_FLAG_BACKWARD = 0x00000001,
;; };
(define enum-_cairo_text_cluster_flags-enum-nvl
  '((CAIRO_TEXT_CLUSTER_FLAG_BACKWARD . 1))
  )
(define enum-_cairo_text_cluster_flags-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_text_cluster_flags-enum-nvl))
(define-public (unwrap-enum-_cairo_text_cluster_flags n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_text_cluster_flags-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_text_cluster_flags v)
  (assq-ref enum-_cairo_text_cluster_flags-enum-vnl v))
...
(define-public cairo_text_extents_t*-desc
  (bs:pointer cairo_text_extents_t-desc))
...
(define-public cairo_font_extents_t*-desc
  (bs:pointer cairo_font_extents_t-desc))
...
(define-public (unwrap-cairo_font_slant_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_font_slant_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_FONT_SLANT_OBLIQUE,
;; };
(define enum-_cairo_font_slant-enum-nvl
  '((CAIRO_FONT_SLANT_NORMAL . 0)
    (CAIRO_FONT_SLANT_ITALIC . 1)
    (CAIRO_FONT_SLANT_OBLIQUE . 2))
  )
(define enum-_cairo_font_slant-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_font_slant-enum-nvl))
(define-public (unwrap-enum-_cairo_font_slant n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_font_slant-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_font_slant v)
  (assq-ref enum-_cairo_font_slant-enum-vnl v))
...
(define-public (unwrap-cairo_font_weight_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_font_weight_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_FONT_WEIGHT_BOLD,
;; };
(define enum-_cairo_font_weight-enum-nvl
  '((CAIRO_FONT_WEIGHT_NORMAL . 0)
    (CAIRO_FONT_WEIGHT_BOLD . 1))
  )
(define enum-_cairo_font_weight-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_font_weight-enum-nvl))
(define-public (unwrap-enum-_cairo_font_weight n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_font_weight-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_font_weight v)
  (assq-ref enum-_cairo_font_weight-enum-vnl v))
...
(define-public (unwrap-cairo_subpixel_order_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_subpixel_order_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_SUBPIXEL_ORDER_VBGR,
;; };
(define enum-_cairo_subpixel_order-enum-nvl
  '((CAIRO_SUBPIXEL_ORDER_DEFAULT . 0)
    (CAIRO_SUBPIXEL_ORDER_RGB . 1)
    (CAIRO_SUBPIXEL_ORDER_BGR . 2)
    (CAIRO_SUBPIXEL_ORDER_VRGB . 3)
...
(define enum-_cairo_subpixel_order-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_subpixel_order-enum-nvl))
(define-public (unwrap-enum-_cairo_subpixel_order n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_subpixel_order-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_subpixel_order v)
  (assq-ref enum-_cairo_subpixel_order-enum-vnl v))
...
(define-public (unwrap-cairo_hint_style_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_hint_style_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_HINT_STYLE_FULL,
;; };
(define enum-_cairo_hint_style-enum-nvl
  '((CAIRO_HINT_STYLE_DEFAULT . 0)
    (CAIRO_HINT_STYLE_NONE . 1)
    (CAIRO_HINT_STYLE_SLIGHT . 2)
    (CAIRO_HINT_STYLE_MEDIUM . 3)
...
(define enum-_cairo_hint_style-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_hint_style-enum-nvl))
(define-public (unwrap-enum-_cairo_hint_style n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_hint_style-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_hint_style v)
  (assq-ref enum-_cairo_hint_style-enum-vnl v))
...
(define-public (unwrap-cairo_hint_metrics_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_hint_metrics_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_HINT_METRICS_ON,
;; };
(define enum-_cairo_hint_metrics-enum-nvl
  '((CAIRO_HINT_METRICS_DEFAULT . 0)
    (CAIRO_HINT_METRICS_OFF . 1)
    (CAIRO_HINT_METRICS_ON . 2))
  )
(define enum-_cairo_hint_metrics-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_hint_metrics-enum-nvl))
(define-public (unwrap-enum-_cairo_hint_metrics n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_hint_metrics-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_hint_metrics v)
  (assq-ref enum-_cairo_hint_metrics-enum-vnl v))
...
;; } cairo_color_mode_t;
(define cairo_color_mode_t-enum-nvl
  '((CAIRO_COLOR_MODE_DEFAULT . 0)
    (CAIRO_COLOR_MODE_NO_COLOR . 1)
    (CAIRO_COLOR_MODE_COLOR . 2))
  )
(define cairo_color_mode_t-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       cairo_color_mode_t-enum-nvl))
(define-public (unwrap-cairo_color_mode_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_color_mode_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-cairo_color_mode_t v)
  (assq-ref cairo_color_mode_t-enum-vnl v))
(define-public unwrap-enum-_cairo_color_mode unwrap-cairo_color_mode_t)
(define-public wrap-enum-_cairo_color_mode wrap-cairo_color_mode_t)
...
;;   CAIRO_COLOR_MODE_COLOR,
;; };
(define enum-_cairo_color_mode-enum-nvl
  '((CAIRO_COLOR_MODE_DEFAULT . 0)
    (CAIRO_COLOR_MODE_NO_COLOR . 1)
    (CAIRO_COLOR_MODE_COLOR . 2))
  )
(define enum-_cairo_color_mode-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_color_mode-enum-nvl))
(define-public (unwrap-enum-_cairo_color_mode n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_color_mode-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_color_mode v)
  (assq-ref enum-_cairo_color_mode-enum-vnl v))
...
(define cairo_font_options_set_color_mode
  (let ((~cairo_font_options_set_color_mode
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (options color_mode)
      (let ((~options
              ((fht-unwrap cairo_font_options_t*) options))
            (~color_mode
              (unwrap-cairo_color_mode_t color_mode)))
        ((force ~cairo_font_options_set_color_mode)
         ~options
         ~color_mode)))))
(export cairo_font_options_set_color_mode)

;; extern cairo_color_mode_t cairo_font_options_get_color_mode(const 
;;     cairo_font_options_t *options);
(define cairo_font_options_get_color_mode
  (let ((~cairo_font_options_get_color_mode
          (delay (fh-link-proc
                   ffi:int
    ...
    (lambda (options)
      (let ((~options
              ((fht-unwrap cairo_font_options_t*) options)))
        (wrap-cairo_color_mode_t
          ((force ~cairo_font_options_get_color_mode)
           ~options))))))
(export cairo_font_options_get_color_mode)

;; extern unsigned int cairo_font_options_get_color_palette(const 
;;     cairo_font_options_t *options);
(define cairo_font_options_get_color_palette
  (let ((~cairo_font_options_get_color_palette
          (delay (fh-link-proc
                   ffi:unsigned-int
    ...
    (lambda (options)
      (let ((~options
              ((fht-unwrap cairo_font_options_t*) options)))
        ((force ~cairo_font_options_get_color_palette)
         ~options)))))
(export cairo_font_options_get_color_palette)

;; extern void cairo_font_options_set_color_palette(cairo_font_options_t *
;;     options, unsigned int palette_index);
(define cairo_font_options_set_color_palette
  (let ((~cairo_font_options_set_color_palette
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (options palette_index)
      (let ((~options
              ((fht-unwrap cairo_font_options_t*) options))
            (~palette_index (unwrap~fixed palette_index)))
        ((force ~cairo_font_options_set_color_palette)
         ~options
         ~palette_index)))))
(export cairo_font_options_set_color_palette)

;; extern void cairo_font_options_set_custom_palette_color(cairo_font_options_t
;;      *options, unsigned int index, double red, double green, double blue, 
;;     double alpha);
(define cairo_font_options_set_custom_palette_color
  (let ((~cairo_font_options_set_custom_palette_color
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (options index red green blue alpha)
      (let ((~options
            ...
            (~blue (unwrap~float blue))
            (~alpha (unwrap~float alpha)))
        ((force ~cairo_font_options_set_custom_palette_color)
         ~options
         ~index
         ~red
         ~green
         ~blue
         ~alpha)))))
(export cairo_font_options_set_custom_palette_color)

;; extern cairo_status_t cairo_font_options_get_custom_palette_color(
;;     cairo_font_options_t *options, unsigned int index, double *red, double *
;;     green, double *blue, double *alpha);
(define cairo_font_options_get_custom_palette_color
  (let ((~cairo_font_options_get_custom_palette_color
          (delay (fh-link-proc
                   ffi:int
    ...
    (lambda (options index red green blue alpha)
      (let ((~options
        ...
        (wrap-cairo_status_t
          ((force ~cairo_font_options_get_custom_palette_color)
           ~options
           ~index
           ~red
           ~green
           ~blue
           ~alpha))))))
(export cairo_font_options_get_custom_palette_color)
...
;; extern unsigned int cairo_font_face_get_reference_count(cairo_font_face_t *
;;     font_face);
...
(define-public (unwrap-cairo_font_type_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_font_type_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_FONT_TYPE_DWRITE,
;; };
(define enum-_cairo_font_type-enum-nvl
  '((CAIRO_FONT_TYPE_TOY . 0)
    (CAIRO_FONT_TYPE_FT . 1)
    (CAIRO_FONT_TYPE_WIN32 . 2)
    (CAIRO_FONT_TYPE_QUARTZ . 3)
...
(define enum-_cairo_font_type-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_font_type-enum-nvl))
(define-public (unwrap-enum-_cairo_font_type n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_font_type-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_font_type v)
  (assq-ref enum-_cairo_font_type-enum-vnl v))
...
;; extern unsigned int cairo_scaled_font_get_reference_count(
...
;;      render_glyph_func);
(define cairo_user_font_face_set_render_color_glyph_func
  (let ((~cairo_user_font_face_set_render_color_glyph_func
          (delay (fh-link-proc
                   ffi:void
      ...
      (let ((~font_face
            ...
            (~render_glyph_func
              ((fht-unwrap
                 cairo_user_scaled_font_render_glyph_func_t)
               render_glyph_func)))
        ((force ~cairo_user_font_face_set_render_color_glyph_func)
         ~font_face
         ~render_glyph_func)))))
(export cairo_user_font_face_set_render_color_glyph_func)
...
;;     font_face);
(define cairo_user_font_face_get_render_color_glyph_func
  (let ((~cairo_user_font_face_get_render_color_glyph_func
          (delay (fh-link-proc
                   ffi-void*
    ...
    (lambda (font_face)
      (let ((~font_face
        ...
        ((fht-wrap
           cairo_user_scaled_font_render_glyph_func_t)
         ((force ~cairo_user_font_face_get_render_color_glyph_func)
          ~font_face))))))
(export cairo_user_font_face_get_render_color_glyph_func)
...
;;     cairo_scaled_font_t *scaled_font);
(define cairo_user_scaled_font_get_foreground_marker
  (let ((~cairo_user_scaled_font_get_foreground_marker
          (delay (fh-link-proc
                   ffi-void*
    ...
    (lambda (scaled_font)
      (let ((~scaled_font
              ((fht-unwrap cairo_scaled_font_t*) scaled_font)))
        ((fht-wrap cairo_pattern_t*)
         ((force ~cairo_user_scaled_font_get_foreground_marker)
          ~scaled_font))))))
(export cairo_user_scaled_font_get_foreground_marker)

;; extern cairo_pattern_t *cairo_user_scaled_font_get_foreground_source(
;;     cairo_scaled_font_t *scaled_font);
(define cairo_user_scaled_font_get_foreground_source
  (let ((~cairo_user_scaled_font_get_foreground_source
          (delay (fh-link-proc
                   ffi-void*
    ...
    (lambda (scaled_font)
      (let ((~scaled_font
              ((fht-unwrap cairo_scaled_font_t*) scaled_font)))
        ((fht-wrap cairo_pattern_t*)
         ((force ~cairo_user_scaled_font_get_foreground_source)
          ~scaled_font))))))
(export cairo_user_scaled_font_get_foreground_source)
...
(define cairo_get_hairline
  (let ((~cairo_get_hairline
          (delay (fh-link-proc
                   ffi:int
                   "cairo_get_hairline"
                   (list ffi-void*)
    ...
    (lambda (cr)
      (let ((~cr ((fht-unwrap cairo_t*) cr)))
        ((force ~cairo_get_hairline) ~cr)))))
(export cairo_get_hairline)
...
(define-public (unwrap-cairo_path_data_type_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_path_data_type_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_PATH_CLOSE_PATH,
;; };
(define enum-_cairo_path_data_type-enum-nvl
  '((CAIRO_PATH_MOVE_TO . 0)
    (CAIRO_PATH_LINE_TO . 1)
    (CAIRO_PATH_CURVE_TO . 2)
    (CAIRO_PATH_CLOSE_PATH . 3))
  )
(define enum-_cairo_path_data_type-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_path_data_type-enum-nvl))
(define-public (unwrap-enum-_cairo_path_data_type n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_path_data_type-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_path_data_type v)
  (assq-ref enum-_cairo_path_data_type-enum-vnl v))

;; typedef union _cairo_path_data_t cairo_path_data_t;
(define-public cairo_path_data_t-desc 'void)
(define-public cairo_path_data_t fh-void)
(define-public cairo_path_data_t? fh-void?)
(define-public make-cairo_path_data_t make-fh-void)
(define-public cairo_path_data_t*-desc (bs:pointer (delay cairo_path_data_t-desc)))
...
(define-public union-_cairo_path_data_t-desc
  (bs:union
    (list `(header
          ...
          `(point ,(bs:struct (list `(x ,double) `(y ,double)))))))
...
(define-public (unwrap-cairo_device_type_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_device_type_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_DEVICE_TYPE_INVALID = -1,
;; };
(define enum-_cairo_device_type-enum-nvl
  '((CAIRO_DEVICE_TYPE_DRM . 0)
    (CAIRO_DEVICE_TYPE_GL . 1)
    (CAIRO_DEVICE_TYPE_SCRIPT . 2)
    (CAIRO_DEVICE_TYPE_XCB . 3)
...
(define enum-_cairo_device_type-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_device_type-enum-nvl))
(define-public (unwrap-enum-_cairo_device_type n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_device_type-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_device_type v)
  (assq-ref enum-_cairo_device_type-enum-vnl v))
...
(define-public (unwrap-cairo_surface_observer_mode_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_surface_observer_mode_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
(define cairo_device_observer_print
  (let ((~cairo_device_observer_print
    ...
    (lambda (abstract_device write_func closure)
      (let ((~abstract_device
              ((fht-unwrap cairo_device_t*) abstract_device))
            (~write_func
              ((fht-unwrap cairo_write_func_t) write_func))
            (~closure (unwrap~pointer closure)))
        (wrap-cairo_status_t
...
(define cairo_device_observer_elapsed
  (let ((~cairo_device_observer_elapsed
    ...
    (lambda (abstract_device)
      (let ((~abstract_device
              ((fht-unwrap cairo_device_t*) abstract_device)))
        ((force ~cairo_device_observer_elapsed)
         ~abstract_device)))))
...
(define-public (unwrap-cairo_surface_type_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_surface_type_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_SURFACE_TYPE_COGL,
;; };
(define enum-_cairo_surface_type-enum-nvl
  '((CAIRO_SURFACE_TYPE_IMAGE . 0)
    (CAIRO_SURFACE_TYPE_PDF . 1)
    (CAIRO_SURFACE_TYPE_PS . 2)
    (CAIRO_SURFACE_TYPE_XLIB . 3)
...
(define enum-_cairo_surface_type-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_surface_type-enum-nvl))
(define-public (unwrap-enum-_cairo_surface_type n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_surface_type-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_surface_type v)
  (assq-ref enum-_cairo_surface_type-enum-vnl v))
...
(define-public cairo_raster_source_snapshot_func_t-desc
  (bs:pointer
    (delay (fh:function
             int
             (list (bs:pointer 'void) (bs:pointer 'void)))))
  )
(define-fh-function*-type
...
(define-public (unwrap-cairo_pattern_type_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_pattern_type_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_PATTERN_TYPE_RASTER_SOURCE,
;; };
(define enum-_cairo_pattern_type-enum-nvl
  '((CAIRO_PATTERN_TYPE_SOLID . 0)
    (CAIRO_PATTERN_TYPE_SURFACE . 1)
    (CAIRO_PATTERN_TYPE_LINEAR . 2)
    (CAIRO_PATTERN_TYPE_RADIAL . 3)
...
(define enum-_cairo_pattern_type-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_pattern_type-enum-nvl))
(define-public (unwrap-enum-_cairo_pattern_type n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_pattern_type-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_pattern_type v)
  (assq-ref enum-_cairo_pattern_type-enum-vnl v))
...
;;     pattern, unsigned int corner_num, double red, double green, double blue
;;     , double alpha);
...
(define-public (unwrap-cairo_extend_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_extend_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_EXTEND_PAD,
;; };
(define enum-_cairo_extend-enum-nvl
  '((CAIRO_EXTEND_NONE . 0)
    (CAIRO_EXTEND_REPEAT . 1)
    (CAIRO_EXTEND_REFLECT . 2)
    (CAIRO_EXTEND_PAD . 3))
  )
(define enum-_cairo_extend-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_extend-enum-nvl))
(define-public (unwrap-enum-_cairo_extend n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_extend-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_extend v)
  (assq-ref enum-_cairo_extend-enum-vnl v))
...
(define-public (unwrap-cairo_filter_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_filter_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_FILTER_GAUSSIAN,
;; };
(define enum-_cairo_filter-enum-nvl
  '((CAIRO_FILTER_FAST . 0)
    (CAIRO_FILTER_GOOD . 1)
    (CAIRO_FILTER_BEST . 2)
    (CAIRO_FILTER_NEAREST . 3)
...
(define enum-_cairo_filter-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_filter-enum-nvl))
(define-public (unwrap-enum-_cairo_filter n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_filter-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_filter v)
  (assq-ref enum-_cairo_filter-enum-vnl v))
...
;;     cairo_pattern_t *pattern, unsigned int patch_num, unsigned int 
;;     corner_num, double *red, double *green, double *blue, double *alpha);
...
(define-public (unwrap-cairo_region_overlap_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_region_overlap_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_REGION_OVERLAP_PART,
;; };
(define enum-_cairo_region_overlap-enum-nvl
  '((CAIRO_REGION_OVERLAP_IN . 0)
    (CAIRO_REGION_OVERLAP_OUT . 1)
    (CAIRO_REGION_OVERLAP_PART . 2))
  )
(define enum-_cairo_region_overlap-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_region_overlap-enum-nvl))
(define-public (unwrap-enum-_cairo_region_overlap n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_region_overlap-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_region_overlap v)
  (assq-ref enum-_cairo_region_overlap-enum-vnl v))
...
(define-public (unwrap-cairo_pdf_version_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_pdf_version_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_PDF_VERSION_1_7,
;; };
(define enum-_cairo_pdf_version-enum-nvl
  '((CAIRO_PDF_VERSION_1_4 . 0)
    (CAIRO_PDF_VERSION_1_5 . 1)
    (CAIRO_PDF_VERSION_1_6 . 2)
    (CAIRO_PDF_VERSION_1_7 . 3))
  )
(define enum-_cairo_pdf_version-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_pdf_version-enum-nvl))
(define-public (unwrap-enum-_cairo_pdf_version n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_pdf_version-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_pdf_version v)
  (assq-ref enum-_cairo_pdf_version-enum-vnl v))
  ...
  (let ((~cairo_pdf_surface_create
    ...
    (lambda (filename width_in_points height_in_points)
      (let ((~filename (unwrap~pointer filename))
        ...
        ((fht-wrap cairo_surface_t*)
         ((force ~cairo_pdf_surface_create)
          ~filename
          ~width_in_points
          ~height_in_points))))))
...
;;     cairo_write_func_t write_func, void *closure, double width_in_points, 
;;     double height_in_points);
(define cairo_pdf_surface_create_for_stream
  (let ((~cairo_pdf_surface_create_for_stream
          (delay (fh-link-proc
                   ffi-void*
    ...
    (lambda (write_func
      ...
      (let ((~write_func
            ...
            (~height_in_points
              (unwrap~float height_in_points)))
        ((fht-wrap cairo_surface_t*)
         ((force ~cairo_pdf_surface_create_for_stream)
          ~write_func
          ~closure
          ~width_in_points
          ~height_in_points))))))
...
;; extern void cairo_pdf_surface_restrict_to_version(cairo_surface_t *surface, 
;;     cairo_pdf_version_t version);
(define cairo_pdf_surface_restrict_to_version
  (let ((~cairo_pdf_surface_restrict_to_version
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (surface version)
      (let ((~surface
        ...
        ((force ~cairo_pdf_surface_restrict_to_version)
         ~surface
         ~version)))))
(export cairo_pdf_surface_restrict_to_version)

;; extern void cairo_pdf_get_versions(cairo_pdf_version_t const **versions, int
;;      *num_versions);
(define cairo_pdf_get_versions
  (let ((~cairo_pdf_get_versions
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (versions num_versions)
      (let ((~versions (unwrap~pointer versions))
        ...
        ((force ~cairo_pdf_get_versions)
         ~versions
         ~num_versions)))))
(export cairo_pdf_get_versions)

;; extern const char *cairo_pdf_version_to_string(cairo_pdf_version_t version);
;;     
(define cairo_pdf_version_to_string
  (let ((~cairo_pdf_version_to_string
          (delay (fh-link-proc
                   ffi-void*
    ...
    (lambda (version)
      (let ((~version (unwrap-cairo_pdf_version_t version)))
        ((force ~cairo_pdf_version_to_string) ~version)))))
(export cairo_pdf_version_to_string)

;; extern void cairo_pdf_surface_set_size(cairo_surface_t *surface, double 
;;     width_in_points, double height_in_points);
(define cairo_pdf_surface_set_size
  (let ((~cairo_pdf_surface_set_size
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (surface width_in_points height_in_points)
      (let ((~surface
            ...
            (~height_in_points
              (unwrap~float height_in_points)))
        ((force ~cairo_pdf_surface_set_size)
         ~surface
         ~width_in_points
         ~height_in_points)))))
...
(define cairo_pdf_outline_flags_t-enum-nvl
  '((CAIRO_PDF_OUTLINE_FLAG_OPEN . 1)
    (CAIRO_PDF_OUTLINE_FLAG_BOLD . 2)
    (CAIRO_PDF_OUTLINE_FLAG_ITALIC . 4))
  )
(define cairo_pdf_outline_flags_t-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       cairo_pdf_outline_flags_t-enum-nvl))
(define-public (unwrap-cairo_pdf_outline_flags_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_pdf_outline_flags_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-cairo_pdf_outline_flags_t v)
  (assq-ref cairo_pdf_outline_flags_t-enum-vnl v))
(define-public unwrap-enum-_cairo_pdf_outline_flags unwrap-cairo_pdf_outline_flags_t)
(define-public wrap-enum-_cairo_pdf_outline_flags wrap-cairo_pdf_outline_flags_t)
...
;;   CAIRO_PDF_OUTLINE_FLAG_ITALIC = 0x4,
;; };
(define enum-_cairo_pdf_outline_flags-enum-nvl
  '((CAIRO_PDF_OUTLINE_FLAG_OPEN . 1)
    (CAIRO_PDF_OUTLINE_FLAG_BOLD . 2)
    (CAIRO_PDF_OUTLINE_FLAG_ITALIC . 4))
  )
(define enum-_cairo_pdf_outline_flags-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_pdf_outline_flags-enum-nvl))
(define-public (unwrap-enum-_cairo_pdf_outline_flags n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_pdf_outline_flags-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_pdf_outline_flags v)
  (assq-ref enum-_cairo_pdf_outline_flags-enum-vnl v))

;; extern int cairo_pdf_surface_add_outline(cairo_surface_t *surface, int 
;;     parent_id, const char *utf8, const char *link_attribs, 
;;     cairo_pdf_outline_flags_t flags);
(define cairo_pdf_surface_add_outline
  (let ((~cairo_pdf_surface_add_outline
          (delay (fh-link-proc
                   ffi:int
                   ...
                   (list ffi-void*
                         ...
                         ffi:int)
                   ffi-cairo-llibs))))
    (lambda (surface parent_id utf8 link_attribs flags)
      (let ((~surface
              ((fht-unwrap cairo_surface_t*) surface))
            (~parent_id (unwrap~fixed parent_id))
            (~utf8 (unwrap~pointer utf8))
            (~link_attribs (unwrap~pointer link_attribs))
            (~flags (unwrap-cairo_pdf_outline_flags_t flags)))
        ((force ~cairo_pdf_surface_add_outline)
         ~surface
         ~parent_id
         ~utf8
         ~link_attribs
         ~flags)))))
(export cairo_pdf_surface_add_outline)
...
(define cairo_pdf_metadata_t-enum-nvl
...
(define cairo_pdf_metadata_t-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       cairo_pdf_metadata_t-enum-nvl))
(define-public (unwrap-cairo_pdf_metadata_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_pdf_metadata_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-cairo_pdf_metadata_t v)
  (assq-ref cairo_pdf_metadata_t-enum-vnl v))
(define-public unwrap-enum-_cairo_pdf_metadata unwrap-cairo_pdf_metadata_t)
(define-public wrap-enum-_cairo_pdf_metadata wrap-cairo_pdf_metadata_t)
...
;;   CAIRO_PDF_METADATA_MOD_DATE,
;; };
(define enum-_cairo_pdf_metadata-enum-nvl
  '((CAIRO_PDF_METADATA_TITLE . 0)
    (CAIRO_PDF_METADATA_AUTHOR . 1)
    (CAIRO_PDF_METADATA_SUBJECT . 2)
    (CAIRO_PDF_METADATA_KEYWORDS . 3)
...
(define enum-_cairo_pdf_metadata-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_pdf_metadata-enum-nvl))
(define-public (unwrap-enum-_cairo_pdf_metadata n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_pdf_metadata-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_pdf_metadata v)
  (assq-ref enum-_cairo_pdf_metadata-enum-vnl v))

;; extern void cairo_pdf_surface_set_metadata(cairo_surface_t *surface, 
;;     cairo_pdf_metadata_t metadata, const char *utf8);
(define cairo_pdf_surface_set_metadata
  (let ((~cairo_pdf_surface_set_metadata
          (delay (fh-link-proc
                   ffi:void
                   "cairo_pdf_surface_set_metadata"
                   (list ffi-void* ffi:int ffi-void*)
                   ffi-cairo-llibs))))
    (lambda (surface metadata utf8)
      (let ((~surface
              ((fht-unwrap cairo_surface_t*) surface))
            (~metadata
              (unwrap-cairo_pdf_metadata_t metadata))
            (~utf8 (unwrap~pointer utf8)))
        ((force ~cairo_pdf_surface_set_metadata)
         ~surface
         ~metadata
         ~utf8)))))
(export cairo_pdf_surface_set_metadata)

;; extern void cairo_pdf_surface_set_custom_metadata(cairo_surface_t *surface, 
;;     const char *name, const char *value);
(define cairo_pdf_surface_set_custom_metadata
  (let ((~cairo_pdf_surface_set_custom_metadata
          (delay (fh-link-proc
                   ffi:void
                   "cairo_pdf_surface_set_custom_metadata"
                   (list ffi-void* ffi-void* ffi-void*)
                   ffi-cairo-llibs))))
    (lambda (surface name value)
      (let ((~surface
              ((fht-unwrap cairo_surface_t*) surface))
            (~name (unwrap~pointer name))
            (~value (unwrap~pointer value)))
        ((force ~cairo_pdf_surface_set_custom_metadata)
         ~surface
         ~name
         ~value)))))
(export cairo_pdf_surface_set_custom_metadata)

;; extern void cairo_pdf_surface_set_page_label(cairo_surface_t *surface, const
;;      char *utf8);
(define cairo_pdf_surface_set_page_label
  (let ((~cairo_pdf_surface_set_page_label
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (surface utf8)
      (let ((~surface
              ((fht-unwrap cairo_surface_t*) surface))
            (~utf8 (unwrap~pointer utf8)))
        ((force ~cairo_pdf_surface_set_page_label)
         ~surface
         ~utf8)))))
(export cairo_pdf_surface_set_page_label)

;; extern void cairo_pdf_surface_set_thumbnail_size(cairo_surface_t *surface, 
;;     int width, int height);
(define cairo_pdf_surface_set_thumbnail_size
  (let ((~cairo_pdf_surface_set_thumbnail_size
          (delay (fh-link-proc
                   ffi:void
    ...
    (lambda (surface width height)
      (let ((~surface
            ...
            (~width (unwrap~fixed width))
            (~height (unwrap~fixed height)))
        ((force ~cairo_pdf_surface_set_thumbnail_size)
         ~surface
         ~width
         ~height)))))
(export cairo_pdf_surface_set_thumbnail_size)
...
(define-public (unwrap-cairo_svg_version_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_svg_version_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_SVG_VERSION_1_2,
;; };
(define enum-_cairo_svg_version-enum-nvl
  '((CAIRO_SVG_VERSION_1_1 . 0)
    (CAIRO_SVG_VERSION_1_2 . 1))
  )
(define enum-_cairo_svg_version-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_svg_version-enum-nvl))
(define-public (unwrap-enum-_cairo_svg_version n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_svg_version-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_svg_version v)
  (assq-ref enum-_cairo_svg_version-enum-vnl v))
...
(define-public (unwrap-cairo_svg_unit_t n)
  (cond
   ((symbol? n)
    (or (assq-ref cairo_svg_unit_t-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
...
;;   CAIRO_SVG_UNIT_PERCENT,
;; };
(define enum-_cairo_svg_unit-enum-nvl
  '((CAIRO_SVG_UNIT_USER . 0)
    (CAIRO_SVG_UNIT_EM . 1)
    (CAIRO_SVG_UNIT_EX . 2)
    (CAIRO_SVG_UNIT_PX . 3)
...
(define enum-_cairo_svg_unit-enum-vnl
  (map (lambda (pair) (cons (cdr pair) (car pair)))
       enum-_cairo_svg_unit-enum-nvl))
(define-public (unwrap-enum-_cairo_svg_unit n)
  (cond
   ((symbol? n)
    (or (assq-ref enum-_cairo_svg_unit-enum-nvl n) (error "bad arg")))
   ((integer? n) n)
   (else (error "bad arg"))))
(define-public (wrap-enum-_cairo_svg_unit v)
  (assq-ref enum-_cairo_svg_unit-enum-vnl v))
...
;; extern void cairo_svg_surface_restrict_to_version(cairo_surface_t *surface, 
...
;; extern void cairo_svg_get_versions(cairo_svg_version_t const **versions, int
;;      *num_versions);
...
;; extern const char *cairo_svg_version_to_string(cairo_svg_version_t version);
;;     
...
;; extern void cairo_svg_surface_set_document_unit(cairo_surface_t *surface, 
...
;; extern cairo_svg_unit_t cairo_svg_surface_get_document_unit(cairo_surface_t 
;;     *surface);
